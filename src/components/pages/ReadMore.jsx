...
//           <img src={snowmobile} alt="Snowmobile" className="read-more__image" />
...
//             repairs.
//           </h2>
//           <img src={snowboard} alt="Snowboard man" className="read-more__image" />
//           <h2 className="read-more__subtitle">
//             We strive to make the repair process as
//             convenient and efficient as possible.
//           </h2>
//           <img src={boy} alt="Boy" className="read-more__image" />
//           <h2 className="read-more__subtitle">
...
//             mind.
//           </h2>
//           <img src={resort} alt="Resort" className="read-more__image" />
//           <h2 className="read-more__subtitle">
