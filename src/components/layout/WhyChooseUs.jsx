  ...
  return (
	<div className="why-choose-us-container">
      <div className="company-icons">
        <div>
          <img src={tesla} alt="Tesla" className="company-items__tesla" />
        </div>
        <div>
          <img
            src={docusign}
        ...
        <div>
          <img src={maze} alt="Maze" className="company-items__maze" />
        </div>
        <div>
          <img src={uber} alt="Uber" className="company-items__uber" />
        </div>
        <div>
          <img src={miro} alt="Miro" className="company-items__miro" />
        </div>
        <div>
          <img src={discord} alt="Discord" className="company-items__discord" />
        </div>
      </div>
      <div className="middle-section">
        <div className="middle-section__content">
          ...
          <div className="middle-section__title-text">
            <div>
              <h1 className="middle-section__title">Why choose US</h1>
            </div>
            <div>
      ...
      <div className="bottom-section">
        <div className="bottom-section__title-text">
          <div>
            <h1 className="bottom-section__title">Service Repair</h1>
          </div>
          <div>
        ...
        <div className="bottom-section__title-text">
          <div>
            <h1 className="bottom-section__title">Board Accessories</h1>
          </div>
          <div>
            <h2 className="bottom-section__text">
              Amet minim mollit non deserunt ullamco est sit aliqua dolor do
